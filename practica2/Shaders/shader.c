...
static void pShader_uniforms(ShaderProgram *theProgram) {
	...
	theProgram->bumpSampler_unif = GetProgramUniform(theProgram->name, theProgram->program, "bumpmap");
	theProgram->texCubemap_unif = GetProgramUniform(theProgram->name, theProgram->program, "cubemap");
